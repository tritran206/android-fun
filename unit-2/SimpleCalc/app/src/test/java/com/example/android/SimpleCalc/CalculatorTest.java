...
public class CalculatorTest {
    ...
    public void subWorksWithNegativeResults() {
        double resultSub = mCalculator.sub(0d, 1d);
        assertThat(resultSub, is(equalTo(-1d)));
    }
